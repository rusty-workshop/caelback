...
_caelback_completions() {
    ...
    commands="snapshot list show restore undo prune star unstar doctor verify-live status reclaim cache-missing install-timer uninstall-timer preview diff export import"
    ...
    case "${COMP_WORDS[1]}" in
        show|restore|doctor|verify-live|star|diff|export)
            local names
